...
const double*
Opm::LeastSquaresProblemSequence::LLSProblem::solve(const double* b) const
{
    // w <- b
...
void Opm::LeastSquaresProblemSequence::push_back(const CoefficientMatrix& A)
{
...
Opm::LeastSquaresProblemSequence::LLSProblem
Opm::LeastSquaresProblemSequence::operator[](const std::size_t i) const
{
    ...
    return {
        ...
        const_cast<std::vector<double>&>(this->house_).data(),
        const_cast<std::vector<double>&>(this->work_).data()
    };
}

void
Opm::LeastSquaresProblemSequence::
...
void Opm::LeastSquaresProblemSequence::factorQR(const std::size_t i)
{
    const auto ncol = this->startHHScale_[i + 1] - this->startHHScale_[i];
    const auto nrow = (this->startMatrix_[i + 1] - this->startMatrix_[i]) / ncol;
...
double
Opm::LeastSquaresProblemSequence::computeHHReflector(const double*     A,
...
void
Opm::LeastSquaresProblemSequence::applyHHReflector(double*           A,
                                                   const double      beta,
                                                   const std::size_t nrow,
...
void
Opm::LeastSquaresProblemSequence::
preserveEssentialHHReflector(double*           A,
                             const std::size_t nrow,
                             const std::size_t col)
{
