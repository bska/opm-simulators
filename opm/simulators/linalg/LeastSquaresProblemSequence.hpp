...
namespace Opm {
    ...
    public:
        ...
        private:
            ...
            /// Coefficient matrix values.  Row major order, meaning A_{ij}
            /// is stored in a_[i + j*ncol_] for zero-based indices i and j.
        ...
        public:
            ...
            const double* solve(const double* b) const;
    ...
    private:
        ...
        using Offset = std::vector<double>::size_type;
        ...
        std::vector<double> matrixData_{};

        /// Scaling data for Householder reflectors for every problem in the
        /// sequence.
        std::vector<double> householderScale_{};
        ...
        mutable std::vector<double> house_{};
        ...
        double computeHHReflector(const double*     A,
        ...
        ///   factorisation.
        void applyHHReflector(double*           A,
                              const double      beta,
                              const std::size_t nrow,
        ...
        void preserveEssentialHHReflector(double*           A,
                                          const std::size_t nrow,
                                          const std::size_t col);
    };
